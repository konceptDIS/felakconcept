...
<div id="content" class="site-content">
                    ...
                    <div class="col-xl-5 col-lg-6 mb-5 mb-xl-0">
                        ...
                        <div class="box-s1 icon-left">
                            ...
                            <div class="icon-box icon-box-2 contact-iconb">
                                ...
                                <div class="content-box">
                                    <h6 class="title-box"><a href="tel:0810 388 0336">Telephone</a></h6>
                                    <p>+234 (0) 810 388 0336 <br>
                                        +234 (0) 905 320 0000 <br>
                                        +234 (0) 909 996 6648</p>
                                </div>
                            </div>
                            <div class="space-30"></div>
                            <div class="icon-box icon-box-2 contact-iconb">
                                ...
                                <div class="content-box">
                                    <h6 class="title-box"><a href="mailto: maxbizz@mail.com">Mail Us</a></h6>
        ...
        <section class="contact-form">
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
                        <form action="http://templates.thememodern.com/maxbizz/contact.php" method="post" class="wpcf7-form main-contact-form">
                            <div class="main-form">
                                <h4>Ready to Get Started?</h4>
                                <div class="row">
                                    <p class="col-md-6">
                                        <input type="text" name="name" size="40" aria-required="true" placeholder="Your Name *">
                                    </p>
                                    <p class="col-md-6">
                                        <input type="email" name="email" size="40" aria-required="true" placeholder="Your Email *">
                                    </p>
                                </div>
                                <p>
                                    <input id="site" type="text" name="site" size="40" aria-invalid="false" placeholder="Website ">
                                </p>
                                <p>
